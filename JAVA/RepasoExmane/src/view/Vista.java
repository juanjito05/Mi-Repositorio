...
public class Vista extends JFrame {
	...
	public void actualizarPantalla(String texto, int i) {
		
		ventanas.get(i).setText(texto);
	}

	public void crearPantalla() {

		JPanel panelPantalla = paneles.get(1);
	...
	private void crearPaneles() {
		...
		JPanel panelPantalla = new JPanel(new GridLayout(2, 0));
	...
	public void hacerBotones(String texto) {
		...
		JPanel panelBotones = paneles.get(0);
